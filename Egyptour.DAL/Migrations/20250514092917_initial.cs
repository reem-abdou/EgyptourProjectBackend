    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripCategory", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TripId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TripCategoryCategoryId = table.Column<int>(type: "int", nullable: false),
                    TripTitle = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    TripsQuantity = table.Column<long>(type: "bigint", nullable: false),
                    ProfileImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trips_TripCategory_TripCategoryCategoryId",
                        column: x => x.TripCategoryCategoryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_TripCategoryCategoryId",
                table: "Trips",
                column: "TripCategoryCategoryId");
